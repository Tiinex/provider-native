...
- Current
  ...
  - Summary: Prove Core/App remain useful without Native installed and prove Native restores the intended local capability when composed.
  - Status: ready/local

---

# Native provider qualification

## Objective

Prove Core/App remain useful without Native installed and prove Native restores the intended local capability when composed.
